...
\begin{exmp}
Wie \exmpref{exmp:kap_3_zeitdis_opt_1}, aber keine Endwertbedingung, dafür Endwertkosten und zusätzliche Steuergrößenbeschränkungen $-1\leq
u[\kappa]\leq 1$ für $\kappa=0,1,2$ und dem Kostenfunktional
\begin{align*}
	K
\end{align*}
\end{exmp}
...
\end{align}
% TODO Python Script draus machen + Plots
